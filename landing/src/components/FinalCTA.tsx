    ...
    >
      <div className="container-x relative">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[32px] border border-white/[0.07] px-6 py-14 sm:py-20 lg:py-24 lg:px-16"
          style={{
            background:
        ...
        >
          {/* Atmosphere */}
          <span
            className="pointer-events-none absolute -top-40 left-1/2 -translate-x-1/2 h-[400px] w-[700px] rounded-full bg-amber-500/[0.14] blur-[100px]"
            aria-hidden
          />
          <span
          ...
          <span
            ...
            style={{ mask: "radial-gradient(circle at center, black 0%, transparent 70%)" }}
            aria-hidden
          />
          ...
          <div className="relative grid grid-cols-12 gap-x-8 gap-y-10">
            <div className="col-span-12 lg:col-span-7">
              ...
              >
                Stop typing.
                <br />
                <span className="serif-italic text-grad-amber">Start talking.</span>
              </h2>
              ...
              <p className="mt-7 mono text-[11px] tracking-[0.16em] uppercase text-stone-500">
            ...
            <div className="col-span-12 lg:col-span-5 lg:col-start-8 flex items-center justify-center">
